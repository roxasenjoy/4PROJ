 ...
 */
final class Version20220316232323 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_grade CHANGE status is_validated TINYINT(1) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_grade CHANGE is_validated status TINYINT(1) NOT NULL');
    }
}
