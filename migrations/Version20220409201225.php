 ...
 */
final class Version20220409201225 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comptability (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, date DATETIME NOT NULL, description VARCHAR(255) NOT NULL, debit INT DEFAULT NULL, credit INT DEFAULT NULL, INDEX IDX_33FA8456A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE comptability ADD CONSTRAINT FK_33FA8456A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
    }
