 ...
 */
final class Version20220410185949 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_extended CHANGE previous_level_id previous_level_id INT DEFAULT NULL');
    }
