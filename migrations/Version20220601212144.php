 ...
 */
final class Version20220601212144 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE notification ADD type VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE notification DROP type, CHANGE message message LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci`');
